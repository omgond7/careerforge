      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary via-primary to-accent flex-col justify-between p-12">
        ...
        <div className="text-white">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-md">
            Join thousands of professionals who are accelerating their careers with AI-powered insights and personalized strategies.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-md mx-auto w-full">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Start building your Career Twin and unlock AI-powered career insights.
            </p>
          </div>
